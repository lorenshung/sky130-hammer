...
################################################################################
if {[::legacy::find -design design:caliptra_top] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:caliptra_top
}
...
# slack
set _slk_ [::legacy::get_attribute slack design:caliptra_top]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:caliptra_top]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:caliptra_top]
...
# power domain count
if {[llength [::legacy::find design:caliptra_top -power_domain *]] != "1"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden # power domains: 1  current # power domains: [llength [::legacy::find design:caliptra_top -power_domain *]]"
}
